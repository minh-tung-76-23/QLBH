...
public class FormHoaDon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpDanhSachHangHoa = new javax.swing.JPanel();
        ...
        tableHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Hóa Đơn", "Mã Khách Hàng", "Mã Nhân Viên", "Mã Sản Phẩm", "Tên Khách Hàng", "Tên Nhân Viên", "Ngày Lập"
            }
        ));
    ...
    private void loadDataToTableHoaDon() {
        try {
            ...
            String sql = "SELECT HOADON.MaHD, HOADON.MaKh, HOADON.MaNv, HOADON.MaHang, HOADON.TenKh, HOADON.TenNhanVien, HOADON.NgayLap, HANGHOA.TenHang " +
                         "FROM HOADON " +
            ...
            while (resultSet.next()) {
                ...
                model.addRow(new Object[]{maHD, maKhachHang, maNhanVien, maSanPham, tenKH, tenNhanVien, ngayLap});
            }
...
//            conn.close();
    ...
    private void btnXoaHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaHDActionPerformed
        ...
        try {
            ...
            String sqlXoaCTHD = "DELETE FROM CTHD WHERE MaHD = ?";
            ...
            String sqlXoaHoaDon = "DELETE FROM HOADON WHERE MaHD = ?";
    ...
    private void capNhatThongTinNhanVien1(String maNhanVien) {
        // Lấy thông tin mới từ các trường nhập liệu
        String tenNhanVien = txtTenNV.getText();

        try {
            Connection conn = DatabaseConnection.getConnection();
            String sql = "UPDATE HOADON SET TenNhanVien = ? WHERE MaNv = ?";
            PreparedStatement preparedStatement = conn.prepareStatement(sql);
            ...
            if (rowsUpdated <= 0) {
                JOptionPane.showMessageDialog(this, "Không thể cập nhật thông tin nhân viên!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            } 
        } catch (SQLException ex) {
    ...
    private void capNhatThongTinKhachHang1(String maKhachHang) {
        ...
        try {
            ...
            // Cập nhật thông tin khách hàng trong bảng HoaDon
            String sqlHoaDon = "UPDATE HOADON SET TenKh = ? WHERE MaKh = ?";
            PreparedStatement preparedStatementHoaDon = conn.prepareStatement(sqlHoaDon);
            preparedStatementHoaDon.setString(1, tenKhachHang);
            preparedStatementHoaDon.setString(2, maKhachHang);

            int rowsUpdatedKhachHang = preparedStatement.executeUpdate();
            int rowsUpdatedHoaDon = preparedStatementHoaDon.executeUpdate();

            // Kiểm tra xem cả hai bảng đã được cập nhật thành công hay không
            if (rowsUpdatedKhachHang > 0 && rowsUpdatedHoaDon > 0) {
                conn.commit(); // Nếu cả hai bảng đều cập nhật thành công, thực hiện commit
                loadDataToTableHoaDon();
            } else {
                conn.rollback(); // Nếu có lỗi, thực hiện rollback
                JOptionPane.showMessageDialog(this, "Không thể cập nhật thông tin khách hàng!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void capNhatThongTinHoaDon(String maHoaDon) {
        ...
        try {
            ...
            // Điền thông tin khác vào preparedStatement
            ...
            if (rowsUpdated > 0) {
                ...
                capNhatThongTinNhanVien1(maNhanVien);
    ...
    private void capNhatThongTinChiTietHoaDon(String maHoaDon) {
        ...
        try {
            Connection conn = DatabaseConnection.getConnection();
            String sql = "UPDATE CTHD SET TenHang = ?, DonGia = ?, SoLuong = ?, ThanhTien = ? WHERE MaHD = ?";
            PreparedStatement preparedStatement = conn.prepareStatement(sql);
    ...
    private void btnThemHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemHDActionPerformed
       // Lấy thông tin từ các thẻ
        ...
        try {
            ...
            String sqlInsertHoaDon = "INSERT INTO HOADON (MaHD, MaKh, MaNv, MaHang, TenKh, TenNhanVien, NgayLap) VALUES (?, ?, ?, ?, ?, ? , ?)";
            ...
            preparedStatementHoaDon.setString(4, maSanPham);
            preparedStatementHoaDon.setString(5, tenKhachHang);
            preparedStatementHoaDon.setString(6, tenNv);
            preparedStatementHoaDon.setDate(7, ngayLap);
            preparedStatementHoaDon.executeUpdate();

            // Thêm thông tin chi tiết hóa đơn vào bảng CHITIETHOADON 
            String sqlInsertChiTietHoaDon = "INSERT INTO CTHD (MaHD, MaHang, TenHang, DonGia, SoLuong, ThanhTien) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            preparedStatementChiTietHoaDon.setString(3, tenSanPham);
            preparedStatementChiTietHoaDon.setInt(4, donGia);
            preparedStatementChiTietHoaDon.setInt(5, soLuong);
            preparedStatementChiTietHoaDon.setInt(6, thanhTien);
    ...
    private void btnCTHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCTHDActionPerformed
        // Tạo form 
        FormCTHD formCTHD = new FormCTHD(); // Truyền tham số 
    ...
    private void txtMaHoaDonFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMaHoaDonFocusLost
        ...
        if (!maHD.isEmpty()) {
            try {
                ...
                "HANGHOA.TenHang AS TenSanPham,CTHD.MaHang, CTHD.DonGia, CTHD.SoLuong, CTHD.ThanhTien " +
                "FROM HOADON " +
                ...
                if (resultSet.next()) {
                    ...
                    txtThanhTien.setText(resultSet.getString("ThanhTien"));
    ...
    private javax.swing.JPanel jpDanhSachHangHoa;
