...
public class FormDangKy extends javax.swing.JFrame {
    ...
    private void btnDangKyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangKyActionPerformed
        ...
        String userName = txtUserNameDK.getText();
        ...
        try {
            ...
            // Kiểm tra xem tên người dùng và mật khẩu đã được nhập hay chưa
            if (userName.isEmpty() || passWord1.isEmpty() || passWord2.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin.");
                return; // Không thực hiện thêm vào cơ sở dữ liệu nếu còn trống
            }

            // Kiểm tra xem mật khẩu nhập lại có trùng khớp với mật khẩu ban đầu không
            if (!passWord1.equals(passWord2)) {
                JOptionPane.showMessageDialog(this, "Mật khẩu nhập lại không chính xác!");
                return; // Không thực hiện thêm vào cơ sở dữ liệu nếu mật khẩu không trùng khớp
            }

            // Tạo truy vấn SQL INSERT để thêm người dùng mới vào bảng NGUOIDUNG
